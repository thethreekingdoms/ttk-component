...
```js
import { i18n } from 'TTK-Component'
import locale from 'TTK-Component/src/locale/lang/en'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/TTK-Component[\/\\]src[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'TTK-Component/src/locale/lang/en')
  ]
}
```
